  ...
  <header><?php require_once 'header.php';?></header>
    ...
    <div class="caixa_pops_escola div_centro">
        <div class="caixa_texto_imagem div_centro">
            ...
            <img class="sombra_imagens img_chamativa" src="img/escolas2.jpg" width="310" height="310" alt="Imagem não encontrada" title="ola">
        </div>
    </div>
    ...
    <div id="caixa_imagens_pops">
        <div class="caixa_central_imagens_pops div_centro">
            ...
            <div class="imagens sombra_imagens">
                <img src="img/escolas4.jpg" width="300" height="300" title="ola" alt="Imagem não encontrada">
            </div>
        </div>
    </div>
